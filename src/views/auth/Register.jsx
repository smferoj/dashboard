        ...
        <div className='bg-[#282046] p-4 rounded-md'>
          <h2 className='text-xl mb-3'> Welcome to E-Commerce</h2>
           ...
           <div className='flex items-center  w-full gap-3 mb-3'>
            <input className='w-4 h-4 text-blue-600 overflow-hidden bg-gray-100 rounded border-gray-300 foucus:ring-blue-500' type="checkbox" name='checkbox' id='checkbox' required/>
            ...
            <div flex items-center mb-3 gap-3 jusitfy-center>
